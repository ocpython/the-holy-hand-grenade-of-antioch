...
variable "azs" {
  default     = ["us-west-2d", "us-west-2c", "us-west-2b"]
...
##############################################################################
# ACM - For referencing an existing certificate in ACM to be attached to ALB
##############################################################################
...
# Currently there are no top-level variables for ElastiCache.
