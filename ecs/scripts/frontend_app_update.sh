...
NEW_FRONTEND_IMAGE_URI="$AWS_ACCOUNT_ID.dkr.ecr.us-west-2.amazonaws.com/frontend:$FRONTEND_IMAGE_TAG"


# register new task definitions
# https://docs.aws.amazon.com/cli/latest/reference/ecs/describe-task-definition.html#description
TASK_FAMILY=$WORKSPACE-nginx
...
TASK_DEFINITION=$( \
  aws ecs describe-task-definition \
    --task-definition $WORKSPACE-nginx \
    | jq -r \
