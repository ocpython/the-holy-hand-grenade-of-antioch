...
def test_get_post_drf_fbv(client):
...
def test_create_post_drf_fbv():
    ...
    response = client.post(reverse("drf-fbv-create-post"), data={"some_field": "some value"})
...
def test_delete_post_drf_fbv():
    ...
    response = client.delete(reverse("drf-fbv-delete-post", kwargs={"pk": post1.id}))
    ...
    response = client.delete(reverse("drf-fbv-delete-post", kwargs={"pk": post2.id}))
...
def test_like_post_drf_fbv():
    ...
    response = client.post(reverse("drf-fbv-like-post", kwargs={"pk": post.id}))
